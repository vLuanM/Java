...
--
-- Host: localhost
-- Tempo de geração: 15-Jun-2023 às 00:42
...
(2, '2019-04-06', 1, 1, 1, 'Lucas Ricardo', '09:41:00'),
...
--
ALTER TABLE `consulta`
  MODIFY `cod_consulta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `dentista`
--
ALTER TABLE `dentista`
  MODIFY `cod_dentista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `secretaria`
  MODIFY `cod_secretaria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
